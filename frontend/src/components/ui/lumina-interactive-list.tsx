...
export function Component() {
  ...
  useEffect(() => {
    ...
    const initApplication = async () => {
      ...
      const slides = [
        { title: 'Chef Special', description: 'Discover premium plates crafted by local kitchens.', media: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?auto=format&fit=crop&w=1400&q=80' },
        { title: 'Fast Dispatch', description: 'Track your order in real time from kitchen to doorstep.', media: 'https://images.unsplash.com/photo-1466978913421-dad2ebd01d17?auto=format&fit=crop&w=1400&q=80' },
        { title: 'Fresh Bowls', description: 'Balanced meals for lunch rush and evening cravings.', media: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&fit=crop&w=1400&q=80' },
        { title: 'Bakery Drop', description: 'Morning pastries and artisan breads delivered warm.', media: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?auto=format&fit=crop&w=1400&q=80' },
        { title: 'Family Packs', description: 'Smart portions and bundle pricing for shared meals.', media: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?auto=format&fit=crop&w=1400&q=80' },
        { title: 'Night Bites', description: 'Late-night favorites available when the city slows down.', media: 'https://images.unsplash.com/photo-1513104890138-7c749659a591?auto=format&fit=crop&w=1400&q=80' }
      ];
      ...
      const updateContent = (idx: number) => {
        ...
        setTimeout(() => {
          ...
          gsap.set(titleEl.children, { y: 20 });
      ...
      const initRenderer = async () => {
        ...
        shaderMaterial = new THREE.ShaderMaterial({
          uniforms: {
            ...
            uEffectType: { value: getEffectIndex('glass') },
    ...
    return () => {
      // The third-party libs are loaded globally and reused.
    };
  }, []);
